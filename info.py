...
auth_channel = environ.get('AUTH_CHANNEL', '-1002456676056') # give your force subscribe channel id here else leave it blank
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/hNt.jpg') # payment code picture url.
