...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002046685711 -1002497540343').split()]  # For Multiple Id Use One Space Between Each.
