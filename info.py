...
PICS = (environ.get('PICS', 'https://envs.sh/GIt.jpg https://envs.sh/j2m.mp4')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002273359017') # give your force subscribe channel id here else leave it blank
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'bec9ce4b25695c1c7539b44dc8983ab5f54b1320')
